"""
Бабοшкина Τатьяна Βладимирοвна
...
"""
a = 'Бабοшкина Τатьяна Βладимирοвна'
""" Задание №1
...
print('№1 ' + str(fio == ['Бабοшкина', 'Τатьяна', 'Βладимирοвна']))
...
"""------------ конец блока редактирования----------------"""
print('№7 ' + str(surname_list == ['Б', 'а', 'б', 'ο', 'ш', 'к', 'и', 'н', 'а']))
...
"""------------ конец блока редактирования----------------"""
print('№8 ' + str(surname_tuple == ('Б', 'а', 'б', 'ο', 'ш', 'к', 'и', 'н', 'а')))
...
"""------------ конец блока редактирования----------------"""
print('№10 ' + str(res == [(0, 'Б'), (1, 'а'), (2, 'б'), (3, 'ο'), (4, 'ш'), (5, 'к'), (6, 'и'), (7, 'н'), (8, 'а')]))
...
"""------------ конец блока редактирования----------------"""
print('№11 ' + str(res == ['а', 'н', 'и', 'к', 'ш', 'ο', 'б', 'а', 'Б']))
...
"""------------ конец блока редактирования----------------"""
print('№13 ' + str(res == ['Б', 'а', 'ο', 'ш', 'к', 'и', 'н', 'а']))
